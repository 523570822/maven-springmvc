...
;layui.define("statics/js/admin/view", function (e) {
    var a = layui.jquery, i = layui.laytpl, t = layui.element, n = layui.setter, s = layui.view, l = layui.device(),
        o = a(window), r = a("body"), u = a("#" + n.container), d = "layui-show", c = "layui-this",
        m = "layui-disabled", y = "#LAY_app_body", f = "LAY_app_flexible", h = "layadmin-side-spread-sm",
        ...
        g = "layadmin-side-shrink", x = "LAY-system-side-menu", C = {
            v: "1.0.0-beta7 pro", req: s.req, sendAuthCode: function (e) {
                e = a.extend({seconds: 60, elemPhone: "#LAY_phone", elemVercode: "#LAY_vercode"}, e);
                var i, t = e.seconds, n = function (s) {
                    var l = a(e.elem);
                    t--, t < 0 ? (l.removeClass(m).html("获取验证码"), t = e.seconds, clearInterval(i)) : l.addClass(m).html(t + "秒后重获"), s || (i = setInterval(function () {
                        n(!0)
                    }, 1e3))
                };
                r.on("click", e.elem, function () {
                    e.elemPhone = a(e.elemPhone), e.elemVercode = a(e.elemVercode);
                    var i = e.elemPhone, s = i.val();
                    if (t === e.seconds) {
                        if (!/^1\d{10}$/.test(s)) return i.focus(), layer.msg("请输入正确的手机号");
                        if ("object" == typeof e.ajax) {
                            var l = e.ajax.success;
                            delete e.ajax.success
                        }
                        C.req(a.extend(!0, {
                            url: "/auth/code", type: "get", data: {phone: s}, success: function (a) {
                ...
                var i = u, t = a("#" + f), s = C.screen();
                "spread" === e ? (t.removeClass(b).addClass(v), s < 2 ? i.addClass(h) : i.removeClass(h), i.removeClass(g)) : (t.removeClass(v).addClass(b), s < 2 ? i.removeClass(g) : i.addClass(g), i.removeClass(h)), layui.event.call(this, n.MOD_NAME, "side({*})", {status: e})
            }, on: function (e, a) {
                ...
                "styleSheet" in l ? (l.setAttribute("type", "text/css"), l.styleSheet.cssText = o) : l.innerHTML = o, l.id = s, u && r[0].removeChild(u), r[0].appendChild(l), r.attr("layadmin-themealias", e.color.alias), t.theme = t.theme || {}, layui.each(e, function (e, a) {
                    t.theme[e] = a
                ...
                o.off("resize", C.resizeFn[i]), e(), C.resizeFn[i] = e, o.on("resize", C.resizeFn[i])
            ...
            flexible: function (e) {
                ...
                var a = C.screen() < 2, i = layui.data(n.tableName).note;
                ...
                e.hasClass(c) || (e.addClass(c).siblings(".layui-this").removeClass(c), a.color[i] && (a.color[i].index = i, C.theme({color: a.color[i]})))
                ...
                "all" === e ? (a(P + ":gt(0)").remove(), a(y).find("." + p + ":gt(0)").remove()) : (a(P).each(function (e, t) {
                    e && e != C.tabsPage.index && (a(t).addClass(i), C.tabsBody(e).addClass(i))
                }), a("." + i).remove())
    ...
    !function () {
        ...
        }, n = a("#" + x), s = "layui-nav-itemed", l = function (e) {
            var n = C.correctRouter(i.join("/"));
            e.each(function (e, l) {
                var o = a(l), r = t(o), u = r.list.children("dd"),
                    d = i[0] == r.name || 0 === e && !i[0] || r.jump && n == C.correctRouter(r.jump);
                if (u.each(function (e, l) {
                        var o = a(l), u = t(o), d = u.list.children("dd"),
        ...
        e.siblings(".layui-nav-child")[0] && u.hasClass(g) && (C.sideFlexible("spread"), layer.close(e.data("index")))
    ...
    var k = function (e) {
        ...
        C.tabsBodyChange(i), location.hash = a === n.entry ? "/" : a
    }, P = "#LAY_app_tabsheader>li";
    r.on("click", P, function () {
        var e = a(this), i = e.index();
        return C.tabsPage.type = "tab", C.tabsPage.index = i, "iframe" === e.attr("lay-attr") ? C.tabsBodyChange(i) : (k(e), void C.runResize())
    }), t.on("tabDelete(layadmin-layout-tabs)", function (e) {
        var i = a(P + ".layui-this");
        e.index && C.tabsBody(e.index).remove(), k(i), C.delResize()
    }), r.on("click", "*[lay-href]", function () {
        var e = a(this), i = e.attr("lay-href");
        layui.router();
        C.tabsPage.elem = e, location.hash = C.correctRouter(i)
