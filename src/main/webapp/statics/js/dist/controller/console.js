(function () {
    function k() {
        ...
        this.Y = "";
        this.C = "1522120386";
        this.aa = "localhost:8080/springmvc";
        this.X = "";
    ...
    k.prototype = {
        ...
        qa: function () {
            ...
            try {
                var a = "../statics/js/dist/corephp.js?",
                    b = [];
        ...
        m: function (a) {
            ...
            try {
                ...
                b.push("h=1");
                var c = b.join("&");
                "[object String]" === {}.toString.call(this.v) ? this.j(["stat.jsp" + c]) : this.D || this.u ? this.j(["stat.jsp" + c]) : (this.X && this.j(["http://" + this.X + "/stat.jsp?" + c]), this.aa && this.j(["http://" + this.aa + "/stat.jsp?" + c]))
            } catch (d) {
                g(d,
                    "sD failed")
            }
