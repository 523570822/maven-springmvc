!function () {
    var p, q, r, a = encodeURIComponent, b = "30088308", c = "", d = "", e = "online_v3.php", f = "q1.cnzz.com", g = "",
        h = "text", i = "q", j = "&#20840;&#26223;&#32479;&#35745;", k = window["_CNZZDbridge_" + b]["bobject"],
        l = "http:", m = "1", n = l + "//online.cnzz.com/online/" + e, o = [];
...
(function () {
    ...
    var p = ['http://www.layui.com/', 'http://www.layui.com/laydate/', 'http://fly.layui.com/', 'http://layer.layui.com/', 'http://layim.layui.com/'],
        e = document, g = window, m = encodeURIComponent, q = "unknow", l = null;
    n.prototype = {
        c: function () {
            ...
            for (var k = 0; k < p.length; k++) {
                var f =
                    p[k];
                if (-1 !== f.indexOf("*")) {
                    for (var e = 0; e < d.length; e++) var c = "/\\" + d[e] + "/g", f = f.replace(eval(c), "\\" + d[e]);
                    c = "/\\*/g";
                    f = f.replace(eval(c), "(.*)");
                    c = RegExp(f, "i");
                    if (c.test(a)) {
